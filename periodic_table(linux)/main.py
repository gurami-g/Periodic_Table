...
# create frames
frame1 = Frame(root, width=600, height=500, bg='#0c456b') #if i want tabs 'notebook'
...
# Group Box
#groupbox3 = ttk.LabelFrame(frame2, text='TEST', width=400, height = 60)
#groupbox3.grid(row=2, column=3, padx=15, pady=15, ipadx=15, ipady=15)
